...
import re
import warnings
from .reaction import reaction, atomic_relaxation
...
class endf_data:
	...
	def _read(self):
		...
		while True:
			...
			MF = endf_data._eint(line[70:72])
			MT = endf_data._eint(line[72:75])
			...
			if MF == 23:
				...
				warnings.warn("Not reading file %d" % MF)
				self._seek_FEND()
	...
	@staticmethod
	def _is_FEND(line):
		MAT = endf_data._eint(line[66:70])
		MF  = endf_data._eint(line[70:72])
		MT  = endf_data._eint(line[72:75])
